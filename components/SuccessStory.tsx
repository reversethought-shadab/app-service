    ...
    <div className="relative w-full max-w-7xl mx-auto p-4 py-20">
      ...
      <div className="md:w-1/2 mt-4 md:mt-0 md:pl-12">
        <p className="text-gray-600">
          Here you can read how we created Android apps from scratch or modernized
          existing apps with new functional features.
        </p>
      </div>
    </div>
      <div className="overflow-hidden rounded-[30px] bg-[#F8F8F8]">
        ...
        >
          {stories.map((story) => (
            <div key={story.id} className="min-w-full flex flex-col md:flex-row items-start p-4">
              ...
              <div className="w-full md:w-1/2 flex justify-center p-4">
                <img src={story.image} alt={story.title} className="max-w-full h-auto rounded-lg" />
              </div>
            </div>
          ))}
        </div>
