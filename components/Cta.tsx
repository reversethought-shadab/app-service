...
const Cta: React.FC<Cta> = ({ title = "Looking for Android developers to create or scale your app?", subtitle = "Fill out the form and we’ll get in touch with you soon.", buttonText = "Get a quote" }) => {
    const waveVariants = {
        ...
        animate: {
            ...
            transition: {
                repeat: Infinity,
                repeatType: "mirror",
                duration: 3, // Reduced duration for faster animation
                ease: "easeInOut",
            }
        }
    };
        ...
        <section className=' max-w-7xl  py-20 mx-auto px-4 sm:px-2 lg:px-8 flex flex-col px-6 md:flex-row items-start py-16 bg-white'>
            <div className="relative bg-black max-w-7xl rounded-[2rem] text-white flex flex-col items-center justify-center ">
                <div className="text-center mb-20 p-[110px] " style={{zIndex:'1'}}>
                    <h1 className="text-4xl font-bold mb-4 ">{title}</h1> {/* Adjusted font size */}
