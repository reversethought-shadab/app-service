...
const Contact = () => {
  return (
    <section className="relative overflow-hidden py-[100px] max-md:pt-25">
    <div className="absolute left-1/2 top-0 -z-10 h-[550px] w-full -translate-x-1/2  bg-[url('/images/hero-gradient.png')] bg-cover bg-center bg-no-repeat opacity-70 md:hidden" />
    <div className="container relative" style={{ opacity: 1, transform: "none" }}>
      <div className="mx-auto mb-12 max-w-[475px] text-center">
        <p className="section-tagline">Contact</p>
        <h2>Request A Demo</h2>
      </div>
      <div className="relative z-1 mx-auto max-w-[850px]">
        <div className="absolute left-1/2 top-1/2 -z-10 flex -translate-x-1/2 -translate-y-1/2 max-md:hidden">
          <div className="h-[442px] w-[442px] rounded-full bg-primary-200/20 blur-[145px]" />
          <div className="-ml-[170px] h-[442px] w-[442px] rounded-full bg-primary-200/25 blur-[145px]" />
          <div className="-ml-[170px] h-[442px] w-[442px] rounded-full bg-primary-200/20 blur-[145px]" />
        </div>
